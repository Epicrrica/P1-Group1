            ...
            <div class="col-md-7 col-lg-5">
                <div class="card shadow-sm border-0 rounded-4 text-center p-4 p-md-5">
                    ...
                    <p class="text-muted fs-5 mb-4">
                        Welcome! Your account is currently awaiting approval. This is to ensure safe trading environment for everyone.
                    </p>
                    
                    <div class="d-grid gap-2">
                        <a href="login.php" class="btn btn-primary py-2 fw-semibold">Return to login page</a>
                    </div>
